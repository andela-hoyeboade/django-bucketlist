...
class SignUpTest(APITestCase):
    def test_create_account_with_valid_details(self):
        ...
        """
        data = {'username': 'hassan', 'email': 'oyeboadehassan@gmail.com', 'password': 'adeola', 'confirm_password': 'adeola'}
        response = self.client.post(register_url, data, format='multipart')
        self.assertEqual(response.status_code, 200)
        self.assertIsNotNone(User.objects.filter(username='hassan'))
    ...
    def test_create_account_with_blank_username(self):
        ...
        """
        url = reverse('apiregister')
        data = {'username': '', 'email': 'oyeboadehassan@gmail.com', 'password': 'adeola', 'confirm_password': 'adeola'}
        response = self.client.post(register_url, data, format='multipart')
        self.assertEqual(response.status_code, 400)
    ...
    def test_create_account_with_blank_email(self):
        ...
        """
        url = reverse('apiregister')
        data = {'username': 'hassan', 'email': '', 'password': 'adeola', 'confirm_password': 'adeola'}
        response = self.client.post(register_url, data, format='multipart')
        self.assertEqual(response.status_code, 400)
    ...
    def test_create_account_with_mismatched_password(self):
        ...
        """
        url = reverse('apiregister')
        data = {'username': 'hassan', 'email': 'oyeboadehassan@gmail.com', 'password': 'adeola', 'confirm_password': 'olaide'}
        response = self.client.post(register_url, data, format='multipart')
        self.assertEqual(response.status_code, 400)

    def test_create_account_with_invalid_username(self):
        """
        Ensure a user cannot create an account with username less than 6 characters
        """
        url = reverse('apiregister')
        data = {'username': 'ade', 'email': 'oyeboadehassan@gmail.com', 'password': 'adeola', 'confirm_password': 'adeola'}
        response = self.client.post(register_url, data, format='multipart')
        self.assertEqual(response.status_code, 400)
    ...
    def test_create_account_without_password(self):
        ...
        """
        url = reverse('apiregister')
        data = {'username': 'hassan', 'email': 'oyeboadehassan@gmail.com', 'password': '', 'confirm_password': 'adeola'}
        response = self.client.post(register_url, data, format='multipart')
        self.assertEqual(response.status_code, 400)
    ...
    def test_create_account_without_confirmation_password(self):
        ...
        """
        url = reverse('apiregister')
        data = {'username': 'hassan', 'email': 'oyeboadehassan@gmail.com', 'password': 'adeola', 'confirm_password': ''}
        response = self.client.post(register_url, data, format='multipart')
        self.assertEqual(response.status_code, 400)

    def test_create_account_with_invalid_password(self):
        """
        Ensure a user cannot create an account with password less than 6 characters
        """
        url = reverse('apiregister')
        data = {'username': 'hassan', 'email': 'oyeboadehassan@gmail.com', 'password': 'ade', 'confirm_password': 'ade'}
        response = self.client.post(register_url, data, format='multipart')
        self.assertEqual(response.status_code, 400)
    ...
    def test_create_account_with_invalid_email(self):
        ...
        """
        url = reverse('apiregister')
        data = {'username': 'hassan', 'email': 'ade', 'password': 'adeola', 'confirm_password': 'adeola'}
        response = self.client.post(register_url, data, format='multipart')
        self.assertEqual(response.status_code, 400)
