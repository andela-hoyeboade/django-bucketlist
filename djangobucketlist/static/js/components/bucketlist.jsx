    ...
    saveNewBucketlist(bucketlistName) {
      ...
      request
        ...
        .end((err, result) => {
          ...
          this.displayFlashMessage(message, messageType)
        });
    }
      ...
      request
        ...
        .end((err, result) => {
          if (result.status === 201) {
            this.props.fetchAllBucketlists();
            this.fetchBucketlistItems(bucketlistId);
            this.displayNewItemFlashMessage("Sucessfully created", "success")
          } else {
            ...
            this.displayNewItemFlashMessage(message, "danger" )
          }
        });
    }
      ...
      request
        ...
        .end((err, result) => {
          if (result.status === 200) {
            this.props.fetchAllBucketlists();
            this.handleDisplayMessage("Succesfully updated", "success")
          } else {
            ...
            this.handleDisplayMessage(message, "danger" )
          }
        });
    }
